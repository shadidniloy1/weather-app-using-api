    ...
    <div className="flex flex-col md:flex-row justify-center items-center my-6 space-y-4 md:space-y-0 md:space-x-4">
      <div className="flex flex-row w-full md:w-3/4 items-center justify-center space-x-4">
        <input
          ...
          type="text"
          placeholder="Search by city..."
          className="bg-white text-gray-500 text-sm md:text-xl font-light p-2 w-full shadow-xl capitalize focus:outline-none placeholder:lowercase"
        />
      ...
      <div className="flex flex-row w-full md:w-1/4 items-center justify-center space-x-2">
        <button
          className="text-sm md:text-2xl font-medium transition ease-out hover:scale-125"
          onClick={() => setUnits("metric")}
        >
          °C
        </button>
        <p className="text-sm md:text-2xl font-medium mx-1">|</p>
        <button
          className="text-sm md:text-2xl font-medium transition ease-out hover:scale-125"
